...
type OrdersDto struct {
	...
	Ema       *int32 `protobuf:"varint,6,opt,name=ema,proto3,oneof" json:"ema,omitempty"`
...
func (x *OrdersDto) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
func (x *OrdersDto) GetLeverage() int32 {
	if x != nil {
		return x.Leverage
	}
	return 0
...
func (x *OrdersDto) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *OrdersDto) GetTimeframe() string {
	if x != nil {
		return x.Timeframe
	}
	return ""
...
func (x *OrdersDto) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *OrdersDto) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_orders_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0xc5, 0x01, 0x0a, 0x09, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x73, 0x44, 0x74, 0x6f, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x12, 0x1a, 0x0a, 0x08,
	0x6c, 0x65, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08,
	0x6c, 0x65, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x71, 0x75, 0x61, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x66, 0x72, 0x61, 0x6d,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x15, 0x0a, 0x03, 0x65, 0x6d, 0x61, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x05, 0x48, 0x00, 0x52, 0x03, 0x65, 0x6d, 0x61, 0x88, 0x01, 0x01, 0x12, 0x17, 0x0a,
	0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x42, 0x06, 0x0a, 0x04, 0x5f, 0x65, 0x6d, 0x61, 0x22, 0x49,
	...
	0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x4a, 0x0a, 0x0d, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x39, 0x0a, 0x0b, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x11, 0x2e, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x73, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x44, 0x74, 0x6f, 0x1a, 0x15, 0x2e, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x73, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0e, 0x5a, 0x0c, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2f, 0x73,
...
var file_orders_proto_goTypes = []any{
	(*OrdersDto)(nil),     // 0: orders.OrdersDto
	(*OrderResponse)(nil), // 1: orders.OrderResponse
}
var file_orders_proto_depIdxs = []int32{
	0, // 0: orders.OrdersService.CreateOrder:input_type -> orders.OrdersDto
	1, // 1: orders.OrdersService.CreateOrder:output_type -> orders.OrderResponse
