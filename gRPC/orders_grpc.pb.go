...
type OrdersServiceClient interface {
	CreateOrder(ctx context.Context, in *OrdersDto, opts ...grpc.CallOption) (*OrderResponse, error)
}
...
func (c *ordersServiceClient) CreateOrder(ctx context.Context, in *OrdersDto, opts ...grpc.CallOption) (*OrderResponse, error) {
...
type OrdersServiceServer interface {
	CreateOrder(context.Context, *OrdersDto) (*OrderResponse, error)
...
func (UnimplementedOrdersServiceServer) CreateOrder(context.Context, *OrdersDto) (*OrderResponse, error) {
...
func _OrdersService_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersServiceServer).CreateOrder(ctx, req.(*OrdersDto))
	}
